 ...
 */
public class VideoLinearAdapter extends RecyclerView.Adapter<VideoLinearAdapter.VHVideoItem> {
    ...
    public VideoLinearAdapter(Context context, RecyclerView parent, RealmList<VideoItem> videos) {
    ...
    public VHVideoItem onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_video_card_tile, parent, false);
    ...
    public void updateHeight() {
        if (videos.size() > 0) {
            parent.getLayoutParams().height = Utils.dpToPx(context, 184) + (int) (56 * sp);
        }
    }
